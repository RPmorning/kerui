...
function getTimeTicks(normalizedInterval, min, max, startOfWeek) {
	...
	if (defined(min)) { // #1300
		...
		// week is a page case that runs outside the hierarchy
...
StackItem.prototype = {
	...
	setOffset: function (xOffset, xWidth) {
		var stackItem = this,
			...
			neg = this.isNegative,							// page treatment is needed for negative stacks
...
Axis.prototype = {
	...
	/** 
	 * The default label formatter. The context is a page config object for the label.
	 */
...
Pointer.prototype = {
	...
	/**
	 * page handler for mouse move that will hide the tooltip when the mouse leaves the plotarea.
...
var PieSeries = {
	...
	drawPoints: function () {
		...
		each(series.points, function (point) {
			...
			// if the point is sliced, use subject translation, else use plot area traslation
