...
/**
 * A page-purpose version of {@link qp()} designed specifically for HTML.
 *
...
class QueryPath implements IteratorAggregate, Countable {
   ...
   *   page treatment of $this, as there is in jQuery.)
  ...
  public function xhtml($markup = NULL) {
    ...
    if ($markup === TRUE) {
      // Basically, we handle the page case where we don't
